...
const THEMES = [
  { id: 'default', name: 'Default Theme', description: 'The standard robust theme.', type: 'free' },
  { id: 'theme-free', name: 'Free Theme', description: 'A basic, clean storefront.', type: 'free' },
  { id: 'minimal', name: 'Minimal', description: 'A sleek, minimalist design focusing on products.', type: 'premium' },
  { id: 'modern', name: 'Modern', description: 'Bold and modern look for contemporary brands.', type: 'premium' },
  { id: 'premium', name: 'Premium', description: 'A high-end, luxurious storefront experience.', type: 'premium' }
];
            ...
            return (
              <div key={theme.id} className={`bg-white rounded-2xl overflow-hidden border-2 transition-all flex flex-col ${isActive ? 'border-[#76b900] shadow-md ring-4 ring-green-50' : 'border-slate-200 hover:border-slate-300 shadow-sm'}`}>
                <div className="h-48 bg-slate-100 flex items-center justify-center border-b border-slate-100 relative">
                  <span className="text-slate-400 font-medium">Theme Preview Placeholder</span>
                  {isLocked && (
